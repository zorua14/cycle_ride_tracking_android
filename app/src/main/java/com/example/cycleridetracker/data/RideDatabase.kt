...
@Database(
    entities = [Ride::class, RidePathPoint::class],
    version = 8,
    autoMigrations = [
        ...
        AutoMigration(from = 7, to = 8, spec = RideDatabase.V7ToV8Migration::class)
    ],
    exportSchema = true
)
...
abstract class RideDatabase : RoomDatabase() {
    ...
    @DeleteColumn(tableName = "rides", columnName = "pathPoints")
    class V7ToV8Migration : AutoMigrationSpec
